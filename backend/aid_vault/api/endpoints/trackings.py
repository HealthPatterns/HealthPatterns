...
def start_tracking(
    db: SessionInstance, current_user: CurrentUserToken, input_data: TrackingSetStart
):
    """
...
def get_tracking(
    db: SessionInstance, current_user: CurrentUserToken, tracking_id: UUID
):
    """
    Get tracking by ID.
    """
...
def set_tracking_end(
    db: SessionInstance,
    current_user: CurrentUserToken,
    tracking_id: UUID,
    tracking_input: TrackingStop,
):
    """
...
def put_tracking_detail(
    db: SessionInstance,
    current_user: CurrentUserToken,
    tracking_id: UUID,
    tracking_input: TrackingOptionals,
):
    """
