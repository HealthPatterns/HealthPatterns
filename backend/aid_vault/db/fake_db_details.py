...
fake_trackings_db = [
        TrackingComplete(id="1", start_time=1697115011, region="head", intensity="5", sleep="7", diet="omnivore"),
        ...
        TrackingComplete(id="3", start_time=1697115011, region="foot", intensity="3", sleep="8", diet="vegan"),
        TrackingComplete(id="4", start_time=1697115011),
